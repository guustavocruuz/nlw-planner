...
public class TripController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Trip> putTrip(@PathVariable UUID id, @RequestBody TripRequestPayload payload){
        Optional<Trip> trip = this.repository.findById(id);
    ...
    public ResponseEntity<Trip> putIsConfirmed(@PathVariable UUID id){
        Optional<Trip> trip = this.repository.findById(id);
